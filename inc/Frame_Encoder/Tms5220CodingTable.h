...
struct Tms5220CodingTable {
    const int rms[16] = {0, 52, 87, 123, 174, 246, 348, 491, 694, 981,
                         1385, 1957, 2764, 3904, 5514, 7789};
    const int rmsSize = 16;

    const int pitch[64] = {0, 15, 16, 17, 18, 19, 20, 21, 22, 23,
                           ...
                           137, 142, 148, 153, 159};
    const int pitchSize = 64;

    const float k1[32] = {-0.97850f, -0.97270f, -0.97070f, -0.96680f, -0.96290f, -0.95900f,
    ...
    const float k2[32] = {-0.64000f, -0.58999f, -0.53500f, -0.47507f, -0.41039f, -0.34129f,
    ...
    const float k3[16] = {-0.86000f, -0.75467f, -0.64933f, -0.54400f, -0.43867f, -0.33333f,
                          -0.22800f, -0.12267f, -0.01733,0.08800f, 0.19333f, 0.29867f,
                          0.40400f, 0.50933f, 0.61467f, 0.72000f};

    const float k4[16] = {-0.64000f, -0.53145f, -0.42289f,-0.31434f, -0.20579f, -0.09723f,
                          0.01132f, 0.11987f, 0.22843f, 0.33698f, 0.44553f, 0.55409f,
                          0.66264f, 0.77119f, 0.87975f, 0.98830f};

    const float k5[16] = {-0.64000f, -0.54933f, -0.45867f, -0.36800f, -0.27733f, -0.18667f,
                          -0.09600f, -0.00533f, 0.08533f, 0.17600f, 0.26667f, 0.35733f,
                          0.44800f, 0.53867f, 0.62933f, 0.72000f};

    const float k6[16] = {-0.50000f, -0.41333f, -0.32667f, -0.24000f, -0.15333f, -0.06667f,
                          0.02000f, 0.10667f, 0.19333f, 0.28000f, 0.36667f, 0.45333f,
                          0.54000f, 0.62667f, 0.71333f, 0.80000f};

    const float k7[16] = {-0.60000f, -0.50667f, -0.41333f, -0.32000f, -0.22667f, -0.13333f,
                          -0.04000f, 0.05333f, 0.14667f, 0.24000f, 0.33333f, 0.42667f,
                          0.52000f, 0.61333f, 0.70667f, 0.80000f};

    const float k8[8] = {-0.50000f, -0.31429f, -0.12857f, 0.05714f, 0.24286f, 0.42857f,
                         0.61429f, 0.80000f};

    const float k9[8] = {-0.50000f, -0.34286f, -0.18571f, 0.02857f, 0.12857f, 0.28571f,
                         0.44286f, 0.60000f};

    const float k10[8] = {-0.40000f, -0.25714f, -0.11429, 0.02857f, 0.17143f, 0.31429f,
                          0.45714f, 0.60000f};

    const float *ks[10] = {k1, k2, k3, k4, k5, k6, k7, k8, k9, k10};
    int kSizes[10] = {32, 32, 16, 16, 16, 16, 16, 8, 8, 8};
};
